...
try {
    ...
    if (!isset($conn)) {
        ...
        $stmt = $conn->prepare("SELECT * FROM registration WHERE user_id = :userID");
        ...
        <div class="row mt-4">
            ...
            <div class="col-lg-6">
                ...
                <form action="update.php" method="POST">
                    ...
                    <input type="hidden" name="userId" value="<?php echo $users[0]['user_id']; ?>">

                    <div class="row mb-3">
                        <div class="col-lg-6">
                            <label><i class="fas fa-user"></i> First Name</label>
                            <div>
                                <input type="text" name="firstName" value="<?php echo $users[0]['first_name']; ?>" placeholder="Enter your first name">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div>
                                <input type="text" name="lastName" value="<?php echo $users[0]['last_name']; ?>" placeholder="Enter your last name">
                    ...
                    <div class="row mb-3">
                        <div class="col-lg-12">
                            ...
                            <div>
                                <input type="email" name="emailAddress" value="<?php echo $users[0]['email_address']; ?>" placeholder="Enter your email address">
                    ...
                    <div class="row mb-3">
                        <div class="col-lg-6">
                            ...
                            <div>
                                <input type="password" name="password" value="<?php echo $users[0]['password']; ?>" placeholder="Enter your password">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div>
                                <input type="password" name="confirmPassword" value="<?php echo $users[0]['password']; ?>" placeholder="Enter your confirm password">
                    ...
                    <div class="row mb-3">
                        <div class="col-lg-6">
                            ...
                            <div>
                                <input type="number" name="phoneNumber" maxlength="10" value="<?php echo $users[0]['phone_number']; ?>" placeholder="Enter your phone number">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div>
                                <input type="text" name="homeAddress" value="<?php echo $users[0]['home_address']; ?>" placeholder="Enter your home address">
                    ...
                    <div class="row mb-3">
                        <div class="col-lg-12">
                            ...
                            <div>
                                <input type="number" name="postalCode" maxlength="5" value="<?php echo $users[0]['postal_code']; ?>" placeholder="Enter your postal code">
                    ...
                    <div class="row mb-3">
                        <div class="col-lg-12 text-end">
                            <button class="registerBtn" type="submit" name="updateBtn">Update</button>
                        </div>
                    </div>
                </form>
            </div>
